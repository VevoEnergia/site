...
export default function Footer() {
  return (
    <footer className="!min-h-96 w-screen px-6 sm:px-8 lg:px-32 2xl:px-60 2xl:py-16 py-8 snap-start  bg-neutral-200 !pb-8">
      <div className="mx-auto max-w-[1920px] grid grid-cols-[2fr_1fr] grid-rows-1 gap-x-24">
        <div className="flex flex-col items-start justify-between h-full">
          ...
          <Subtitle className="text-2xl text-secondary max-w-xl">
