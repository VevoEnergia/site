...
export default function Footer() {
  return (
    <footer className="!min-h-96 w-screen px-6 sm:px-8 lg:px-32 2xl:px-60 2xl:py-16 py-8 snap-start grid grid-cols-[2fr_1fr] grid-rows-1 gap-x-24 row-span-3 bg-neutral-200 !pb-8">
